...
def handle_start_help(message):
    ...
    bot.send_message(message.chat.id, "Hi, i can turn your photo to pixel art. Try i sending me some pic!")
...
def log_like(call: types.CallbackQuery):
    ...
    bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id, reply_markup=get_like_markup())
...
def log_dislike(call: types.CallbackQuery):
    ...
    bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id, reply_markup=get_dislike_markup())
